...
public class QServiceCfg {
    ...
    QServiceCfg(Context context, String region,String appid, String secretId, String secretKey, String sessionToken, long expiredTime, String uploadCosPath,String localUrl) {
        ...
        LocalSessionCredentialProvider localCredentialProvider = new LocalSessionCredentialProvider(secretId, secretKey, sessionToken, expiredTime);
        ...
        bucketForObjectAPITest = "kindergartens";
